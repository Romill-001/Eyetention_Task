...
if __name__ == '__main__':
    ...
    cf = {"model_pretrained": "bert-base-multilingual-cased",
          ...
          "max_sp_len": 400,  # Adjust based on MECO dataset
          "norm_type": "z-score",
    ...
    for train_idx, test_idx in kf.split(split_list):
        ...
        # Save results
        with open('{}/res_MECO_{}_eyettention_{}_Fold{}.pickle'.format(args.save_data_folder, args.test_mode, args.atten_type, fold_indx), 'wb') as handle:
